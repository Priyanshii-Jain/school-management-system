					  ...
					  <div class="row">
						<div class="col-12">
                            ...
                            <div class="row">
								...
								<div class="controls">
									<input type="text" name="full_marks[]" value="{{ $edit->full_marks }}"class="form-control">
                                </div>								
							</div>
                                </div> <!-- end col-md-5 -->
								...
								<div class="controls">
									<input type="text" name="passing_marks[]" value="{{ $edit->passing_marks }}" class="form-control">
                                </div>								
							</div>
                                </div> <!-- end col-md-5 -->
								...
								<div class="controls">
									<input type="text" name="subjective_marks[]" value="{{ $edit->subjective_marks }}"class="form-control">
                                </div>								
							</div>
                                </div> <!-- end col-md-5 -->
